...
export const FORM_TYPES: FormTypeInfo[] = [
  {
    ...
    columns: [
      ...
      { name: 'devise_originale',          required: false, example: 'CAD' },
      { name: 'prix_devise_originale',     required: false, example: '49.95' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'fournisseur',               required: false, example: 'Springer Nature' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'categorie_document',        required: false, example: 'Périodique' },
      { name: 'format_support',            required: false, example: 'Électronique' },
      { name: 'fonds_budgetaire',          required: false, example: 'PE-001' },
      { name: 'fournisseur',               required: false, example: 'Gallimard' },
      { name: 'prix_cad',                  required: false, example: '49.95' },
      { name: 'devise_originale',          required: false, example: 'CAD' },
      { name: 'prix_devise_originale',     required: false, example: '49.95' },
      { name: 'source_information',        required: false, example: 'https://www.example.com' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'editeur',                     required: false, example: 'Springer' },
      { name: 'categorie_document',          required: false, example: 'Monographie' },
      { name: 'format_support',              required: false, example: 'Électronique' },
      { name: 'fonds_budgetaire',            required: false, example: 'PE-001' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'isbn_issn',                    required: false, example: '9782070360024' },
      { name: 'editeur',                      required: false, example: 'PUF' },
      { name: 'categorie_document',           required: false, example: 'Monographie' },
      { name: 'format_support',               required: false, example: 'Imprimé/support physique' },
      { name: 'fonds_budgetaire',             required: false, example: 'SA-001' },
      { name: 'fournisseur',                  required: false, example: 'Amazon' },
      { name: 'prix_cad',                     required: false, example: '49.95' },
      { name: 'devise_originale',             required: false, example: 'CAD' },
      { name: 'prix_devise_originale',        required: false, example: '49.95' },
      { name: 'source_information',           required: false, example: 'https://...' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'isbn_issn',                    required: false, example: '9782070360024' },
      { name: 'editeur',                      required: false, example: 'O\'Reilly' },
      { name: 'categorie_document',           required: false, example: 'Monographie' },
      { name: 'format_support',               required: false, example: 'Imprimé/support physique' },
      { name: 'fonds_budgetaire',             required: false, example: 'SC-001' },
      { name: 'fournisseur',                  required: false, example: 'Amazon' },
      { name: 'prix_cad',                     required: false, example: '79.95' },
      { name: 'devise_originale',             required: false, example: 'CAD' },
      { name: 'prix_devise_originale',        required: false, example: '79.95' },
      { name: 'source_information',           required: false, example: 'https://...' },
