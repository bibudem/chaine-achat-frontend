...
@Component({
  ...
  templateUrl: './mise-a-jour-monografies.component.html',
  styleUrls: ['./mise-a-jour-monografies.component.css']
})
export class MiseAjourMonographieComponent implements OnInit {
